...
const QuoteSchema = zod_1.z.object({
    fromAsset: zod_1.z.enum(['USDC', 'USDT', 'DAI']),
    amountUsd: zod_1.z.number().positive().max(250_000),
    deliveryMode: zod_1.z.enum(['UPI_INSTANT', 'IMPS_NEFT', 'IINR_WALLET', 'AADHAAR_PAY']),
});
