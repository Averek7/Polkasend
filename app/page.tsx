    ...
    <div className="min-h-screen" style={{ background: "#0a0a0a" }}>
      ...
      <div
        ...
        style={{
          ...
          height: "700px",
          background:
            "radial-gradient(circle, rgba(230,0,122,0.1) 0%, transparent 70%)",
          zIndex: 0,
        }}
      />
      <div
      ...
      <main className="relative z-10">
        ...
        <section className="pt-36 pb-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              Near-instant settlement via UPI. Fully KYC/AML compliant. Built
              with custom FRAME pallets and XCM.
            </motion.p>
        ...
        <section className="px-6 pb-16">
          <div className="max-w-5xl mx-auto">
            <div
              className="grid grid-cols-2 md:grid-cols-4 gap-1 overflow-hidden rounded-2xl"
              style={{
              ...
              {STATS.map((s, i) => (
                <motion.div
                  ...
                  style={{
                    background: "#16161e",
                    borderRight:
                      i < 3 ? "1px solid rgba(255,255,255,0.07)" : undefined,
                  }}
                >
                  <div
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <p style={{ color: "#7070a0" }}>
                Built different. Designed for India's $129B remittance market.
              </p>
            </motion.div>
        ...
        <section className="px-6 pb-24">
          <div className="max-w-2xl mx-auto text-center">
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(230,0,122,0.08), rgba(108,159,255,0.05))",
                border: "1px solid rgba(230,0,122,0.2)",
              }}
            >
              ...
              <p className="mb-8" style={{ color: "#7070a0" }}>
                Connect your Polkadot wallet and send your first remittance in
                under 2 minutes.
              </p>
              <Link href="/send">
                <motion.button
      ...
      >
        <div className="font-mono text-xs">
          PolkaSend · Built on Polkadot · Parachain #3000 · XCM v4 · Substrate
          FRAME
        </div>
      </footer>
    </div>
